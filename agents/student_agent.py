...
class StudentAgent(Agent):
    ...
    def step(self, chess_board, my_pos, adv_pos, max_step):
        ...
        if self.tree == None:
            ...
            self.tree.search(20)
            pos, dir = self.tree.best_move()
            self.tree.root_state.set_barrier(state.chess_board, pos[0], pos[1], dir)
            self.tree.root_state.my_pos = pos
            self.tree.root = self.tree.root.children[(pos, dir)]
